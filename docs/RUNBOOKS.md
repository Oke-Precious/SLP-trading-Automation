# AutoSLP Operational & Fault-Tolerance Runbooks

This document contains standard operational playbooks, live replication steps, failover triggers, cache re-seeds, and emergency disaster recovery procedures for the AutoSLP engine.
